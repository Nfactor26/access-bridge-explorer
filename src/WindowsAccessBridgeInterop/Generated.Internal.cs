...
namespace WindowsAccessBridgeInterop
{
    ...
    internal partial class AccessBridgeNativeFunctions : AccessBridgeFunctions
    {
        ...
        public override bool RequestFocus(int vmid, JavaObjectHandle accessibleContext)
        {
            var result = EntryPoints.RequestFocus(vmid, Unwrap(vmid, accessibleContext));
    ...
    internal class AccessBridgeEntryPoints
    {
        ...
        public delegate BOOL RequestFocusFP(int vmid, JOBJECT64 accessibleContext);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
